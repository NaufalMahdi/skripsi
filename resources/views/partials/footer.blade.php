...
<footer id="footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-info">
                        <h3>Website Smpn 1 Jember</h3>
                        <p>
                            Jl.Dewi Sartika No.17, Kampungtengah, Kepatihan, Kec. Kaliwates, Kabupaten Jember, Jawa
                            Timur <br>
                            Jember<br><br>
                            <strong>Phone:</strong> (0331) 486988<br>
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span>Sebagai Penelitian</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            ...
            Designed by <a href="https://bootstrapmade.com/">NaufalM/Website Untuk Penelitian </a>
        </div>
    </div>
</footer><!-- End Footer -->
