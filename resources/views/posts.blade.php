                ...
                <div class="card mb-3">
                    @if ($posts[0]->image)
                        <div style="max-height: 350px; overflow:hidden;">
                            <img src="{{ asset('uploads/' . $posts[0]->image) }}" alt="{{ $posts[0]->kategori->name }}"
                        ...
                        <div style="width:100%;height:200px;">
                            <p>
                                <small class="text-muted">
                                    Kategori : <a
                                        href="/kategories/{{ $posts[0]->kategori->slug }} ">{{ $posts[0]->kategori->name }}
                                    </a>
                                </small>
                            </p>
            ...
            @foreach ($posts->skip(1) as $post)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        @if ($post->image)
                            <img src="{{ asset('storage/' . $post->image) }}" alt="{{ $post->kategori->name }}"
                                class="img-fluid">
                        @else
